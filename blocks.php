    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Other<span class="caret"></span></a>
        <ul class="dropdown-menu">
          ...
          <li class="active"><a href="blocks.php">Blocks</a></li>
        </ul>
    </li>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="no_of_students" placeholder="No of Students" class="form-control"/>
                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    <label for="update_no_of_students">No of Students</label>
                    <input type="text" id="update_no_of_students" placeholder="No of Students" class="form-control"/>
                </div>
