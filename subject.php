        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="sub_name" placeholder="Subject Name" class="form-control"/>
                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    <label for="update_sub_name">Subject Name</label>
                    <input type="text" id="update_sub_name" placeholder="Subject Name" class="form-control"/>
                </div>
